...
class GroqTranslator(CommonTranslator):
    ...
    '\n'
    '**Possessives & Gender Inference**\n'
    '- DO NOT insert possessives like "his/her/their" unless explicitly stated in the source.\n'
    '- If the subject is omitted, translate without a pronoun (e.g., "舐めてやりたいな" → "I want to lick the nape" instead of "I want to lick his nape").\n'
