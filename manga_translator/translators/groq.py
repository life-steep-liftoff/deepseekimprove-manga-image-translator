...
class GroqTranslator(CommonTranslator):
    ...
    '- If the source uses a neutral family term (e.g., 親子, 子供), do not assume gender. Use gender-neutral translations (e.g., 親子→parent and child, 子供→child) unless gender is explicitly stated.\n'
    '\n'
