...
class GroqTranslator(CommonTranslator):
    ...
    '- If the source lacks pronouns, infer based on the previous speaker’s context while maintaining consistency.\n'
    '\n'
    ...
    '- For Llama: Enable context-aware analysis for better continuity.\n'
    '\n'
